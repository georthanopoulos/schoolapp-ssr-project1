...
public record TeacherInsertDTO(
        ...
        @NotNull(message = "Το όνομα δεν μπορει να είναι κενό.")
        @Size(min = 2, message = "Το όνομα πρέπει να περιέχει τουλάχιστον δύο χαρακτήρες.")
        String firstname,


        @NotNull(message = "Το επώνυμο δεν μπορει να είναι κενό.")
        @Size(min = 2, message = "Το επώνυμο πρέπει να περιέχει τουλάχιστον δύο χαρακτήρες.")
        String lastname,

        @Pattern(regexp = "\\d{9,}", message = "Το ΑΦΜ δεν μπορεί να είναι μικρότερο απο εννέα ψηφία.")
        String vat,
